...
training_data_dir = data_dir + 'output_coco\\'
validation_data_dir = data_dir + 'output_coco\\'

# Local path to trained weights file
COCO_MODEL_PATH = os.path.join(ROOT_DIR, model_file)
...
class ToothDataset(utils.Dataset):
    def load_data(self, dataset_dir, return_coco=False):
        ...
        coco = COCO(dataset_dir + "\\region_data.json")
...
for img_id in image_ids:
    ...
    mask, classids = dataset_train.load_mask(img_id)
    visualize.display_top_masks(image, mask, classids, dataset_train.class_names)
